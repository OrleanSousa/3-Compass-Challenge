    ...
    <div className='flex justify-center items-center bg-qualitback w-[1440px] h-[270px]'>
        <div className='flex w-[1344px] h-[70px] justify-between'>
            <div className='flex items-center gap-[10px] '>
                <img src="/fotos-furniro/trofeu.png" alt="" className='w-[52.77px] h-[60px]'/>
                <div>
            ...
            <div className='flex items-center gap-[10px]'>
                <img src="/fotos-furniro/verificado.png" alt="" className='w-[60px] h-[58.13px]'/>
                <div>
            ...
            <div className='flex items-center gap-[10px]'>
                <img src="/fotos-furniro/entrega.png" alt="" className='w-[60px] h-[55.97px]'/>
                <div>
                    <h2 className='text-[25px] font-semibold text-textqualit'>High Quality</h2>
                    <p className='text-textCardB text-[20px]'>crafted from top materials</p>
                </div>
            ...
            <div className='flex items-center gap-[10px]'>
                <img src="/fotos-furniro/atendente.png" alt="" className='w-[52.94px] h-[60px]'/>
                <div>
